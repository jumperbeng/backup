...
if("TRUE" STREQUAL "TRUE")
  set(human_model_SOURCE_PREFIX /home/jumper/Documents/bwi_my_ws/human_model_ws/src/human_model)
  set(human_model_DEVEL_PREFIX /home/jumper/Documents/bwi_my_ws/human_model_ws/devel)
  ...
  set(human_model_INSTALL_PREFIX /home/jumper/Documents/bwi_my_ws/human_model_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'human_model' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Bilgin Coşkun <bilgin.coskun@metu.edu.tr>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'human_model' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jumper/Documents/bwi_my_ws/human_model_ws/src/human_model/${idir}'.  Ask the maintainer 'Bilgin Coşkun <bilgin.coskun@metu.edu.tr>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jumper/Documents/bwi_my_ws/human_model_ws/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${human_model_dep}_FOUND)
      find_package(${human_model_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${human_model_dep} REQUIRED ${depend_list})
  endif()
