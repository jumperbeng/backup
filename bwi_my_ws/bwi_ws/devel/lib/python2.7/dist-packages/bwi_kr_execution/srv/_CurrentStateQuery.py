...
"""autogenerated by genpy from bwi_kr_execution/CurrentStateQueryRequest.msg. Do not edit."""
import sys
...
class CurrentStateQueryRequest(genpy.Message):
  ...
  _type = "bwi_kr_execution/CurrentStateQueryRequest"
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from bwi_kr_execution/CurrentStateQueryResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class CurrentStateQueryResponse(genpy.Message):
  ...
  _type = "bwi_kr_execution/CurrentStateQueryResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.answer is None:
        self.answer = bwi_kr_execution.msg.AnswerSet()
    else:
      self.answer = bwi_kr_execution.msg.AnswerSet()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.answer.satisfied))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.answer.satisfied,) = _struct_B.unpack(str[start:end])
...
class CurrentStateQuery(object):
  _type          = 'bwi_kr_execution/CurrentStateQuery'
