...
if("TRUE" STREQUAL "TRUE")
  set(bwi_services_SOURCE_PREFIX /home/jumper/Documents/bwi_my_ws/bwi_ws/src/bwi_common/bwi_services)
  set(bwi_services_DEVEL_PREFIX /home/jumper/Documents/bwi_my_ws/bwi_ws/devel)
  ...
  set(bwi_services_INSTALL_PREFIX /home/jumper/Documents/bwi_my_ws/bwi_ws/install)
...
if(NOT "/home/jumper/Documents/bwi_my_ws/bwi_ws/devel/include " STREQUAL " ")
  set(bwi_services_INCLUDE_DIRS "")
  set(_include_dirs "/home/jumper/Documents/bwi_my_ws/bwi_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'bwi_services' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Benjamin Singer <benjamin.z.singer@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'bwi_services' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jumper/Documents/bwi_my_ws/bwi_ws/src/bwi_common/bwi_services/${idir}'.  Ask the maintainer 'Benjamin Singer <benjamin.z.singer@gmail.com>' to fix it.")
    endif()
...
set(bwi_services_EXPORTED_TARGETS "bwi_services_generate_messages_cpp;bwi_services_generate_messages_lisp;bwi_services_generate_messages_py")
...
set(depends "actionlib;bwi_kr_execution;message_runtime;roscpp;std_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${bwi_services_dep}_FOUND)
      find_package(${bwi_services_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${bwi_services_dep} REQUIRED ${depend_list})
  endif()
